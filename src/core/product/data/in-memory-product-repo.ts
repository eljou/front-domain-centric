...
export function makeProductInMemoryRepository(): ProductRepository {
  const products = [
    {
      id: "1",
      image:
    ...
    },
    {
      id: "2",
      image:
        "https://m.media-amazon.com/images/W/MEDIAX_792452-T1/images/I/61oenDt4A-L._AC_UL640_FMwebp_QL65_.jpg",
